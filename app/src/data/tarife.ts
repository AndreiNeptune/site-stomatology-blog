...
export const tarifeData: CategorieTarife[] = [
  ...
  },
  {
    ...
    servicii: [
      ...
      { id: "e2", nume: "Tratament endodontic primar - 1 canal", pret: "500 RON" },
      { id: "e3", nume: "Tratament endodontic primar - 2 canale", pret: "600 RON" },
      { id: "e4", nume: "Tratament endodontic primar - 3 canale +", pret: "750 RON" },
  ...
  },
  {
    ...
    servicii: [
      ...
      { id: "pr2", nume: "Profilaxie adult (detartraj și periaj profesional) + AirFlow", pret: "350 RON" },
  ...
  },
  {
    ...
    servicii: [
      { id: "ed1", nume: "Tratament de albire a dinților în cabinet (vitali)", pret: "1250 RON" },
